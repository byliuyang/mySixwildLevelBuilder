 ...
 */
public class ChangeTileFiveProbabilityController extends ChangePreferenceController{

    public ChangeTileFiveProbabilityController(EditLevelScreen editLevelScreen, JTextField numberTextField) {
