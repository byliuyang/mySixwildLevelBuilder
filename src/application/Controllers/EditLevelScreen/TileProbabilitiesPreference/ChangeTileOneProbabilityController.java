 ...
 */
public class ChangeTileOneProbabilityController extends ChangePreferenceController{

    public ChangeTileOneProbabilityController(EditLevelScreen editLevelScreen, JTextField numberTextField) {
