 ...
 */
public class ChangeTileSixProbabilityController extends ChangePreferenceController{

    public ChangeTileSixProbabilityController(EditLevelScreen editLevelScreen, JTextField numberTextField) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            level.getGrid().getProbabilities().getTileSix().setValue(probability);
        } catch (Exception ex) {
