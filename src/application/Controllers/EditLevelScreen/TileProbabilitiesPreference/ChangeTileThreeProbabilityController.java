 ...
 */
public class ChangeTileThreeProbabilityController extends ChangePreferenceController{

    public ChangeTileThreeProbabilityController(EditLevelScreen editLevelScreen, JTextField numberTextField) {
