 ...
 */
public class ChangeTileTwoProbabilityController extends ChangePreferenceController{

    public ChangeTileTwoProbabilityController(EditLevelScreen editLevelScreen, JTextField numberTextField) {
